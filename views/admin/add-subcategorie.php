...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Ajouter sous_catégorie</h1>
  </div> 
<section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
    <h4>Ajouter sous_catégorie</h4>
    <form method="post">
        <label class="form-label">Nom de sous_categorie:</label>
        <input type="text" class="form-control mb-4" name="nom_subcategorie" >
        <label class="form-label">Slug de sous_categorie:</label>
        <input type="text" class="form-control mb-4" name="slug_subcategorie">
        ...
        <input type="submit" class="btn btn-primary my-2" name="ajouter">
    </form>
      </div>
    </div>
</section>
